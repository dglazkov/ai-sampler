...
Optionally, create the `allowed-domains.txt` file listing the origins (one per line) of domains you would like this app to allow cross-origin requests from. The line can a case-sensitive origin string or a glob pattern.
